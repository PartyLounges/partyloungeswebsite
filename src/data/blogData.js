const blogData = [
  {
    ...
    During the Renaissance, decor flourished as art and architecture blended seamlessly. Palaces and churches were adorned with ornate frescoes, gold embellishments, and intricate furniture. By the 18th century, the Rococo style brought playful elegance with pastel colors and curved lines./n
  ...
  },
  {
    ...
    date: "March 18, 2024",
    body: `Event planning is both an art and a science. It begins with a clear vision—a goal that determines the theme, size, and audience of the event. The next step is setting a budget, which dictates everything from the venue to decorations and catering. Successful planners prioritize communication, ensuring all stakeholders, from vendors to clients, are on the same page./n
    A timeline is key to execution. Break the event into phases: research, booking, marketing, and logistics. Technology tools like event management software can streamline this process./n
    On the day of the event, attention to detail becomes crucial. Coordinating staff, troubleshooting issues, and ensuring guest satisfaction are non-negotiable. Finally, post-event evaluation allows organizers to identify areas of improvement, ensuring future events are even better./n`,
    author: {
      name: "Kelvin Kuria",
  ...
  },
  {
    ...
    date: "March 20, 2024",
    body: `Lighting is a critical element in event design, capable of transforming spaces and evoking emotions. The first trend is LED uplighting, which adds color and energy to walls and structures. LEDs are cost-effective, eco-friendly, and versatile./n
    Secondly, projection mapping is revolutionizing events. By projecting digital imagery onto surfaces, organizers can create dynamic, interactive backdrops tailored to themes./n
    Chandeliers and fairy lights are trending in both indoor and outdoor events, creating elegance and whimsy. For corporate events, modern geometric lighting fixtures are gaining popularity./n
    Another emerging trend is smart lighting, controlled via apps to adjust brightness and color schemes in real time. This enables dynamic lighting that matches the mood throughout the event./n
    Lastly, natural lighting for daytime events, combined with subtle artificial enhancements, creates an Instagram-worthy aesthetic that resonates with modern audiences./n`,
    author: {
      name: "Lucy Kamau",
  ...
  },
  {
    ...
    body: `Catering is more than just food; it’s an experience that can leave a lasting impression. In 2024, sustainability is at the forefront of catering trends. Guests appreciate eco-friendly options such as locally sourced produce, plant-based meals, and minimal food waste./n
    Interactive food stations are also gaining popularity. Think DIY taco bars, live pasta cooking stations, and personalized dessert counters that allow guests to customize their meals. Smaller, creative portions such as tapas and tasting menus provide variety and excitement./n
  ...
  },
  {
    ...
    body: `Lighting is one of the most powerful tools in event design. It sets the mood, highlights key elements, and transforms any space into something extraordinary. The right lighting can make a small venue look grand or a large venue feel intimate./n 
    Consider using LED uplighting to create vibrant effects on walls, while spotlights can highlight areas like stages or speakers. For weddings and galas, soft lighting with candles, fairy lights, and chandeliers creates a romantic and elegant atmosphere./n 
    Colored lighting adds personality and can match the event's theme. For corporate events, sleek and dynamic lighting conveys professionalism, while warm tones are great for social gatherings. Always test lighting before the event to ensure it enhances the venue's aesthetics and aligns with your event's vision./n`,
    date: "April 30, 2024",
    author: {
      name: "Kevin Otieno",
  ...
  },
  {
    ...
    body: `Successful event planning requires meticulous organization. This ultimate checklist ensures you don’t miss a step./n
    Start with defining your event's purpose and setting a budget. Next, choose a venue that aligns with your goals and audience. Book key vendors early—caterers, entertainment, AV teams, and photographers. Create a timeline for marketing and promotions to ensure attendees know about the event./n
    Finalize guest lists, send invites, and track RSVPs. Plan decor, seating, and logistics such as transportation, permits, and parking. A few days before the event, confirm vendor details and conduct a final venue walkthrough. Always have a contingency plan in place. Post-event, follow up with thank-yous and gather feedback for future improvement./n`,
    date: "May 5, 2024",
    author: {
      name: "Claire Njeri",
      title: "Event Planner",
  ...
  },
  {
    ...
    body: `Technology has revolutionized the events industry. From event apps to virtual platforms, tech tools are boosting attendee engagement and improving planning efficiency. Mobile event apps provide schedules, speaker details, and networking opportunities, making them ideal for large conferences and expos./n 
    Virtual and hybrid events allow global participation and increase accessibility. Livestreams, video conferencing, and interactive polls ensure everyone feels involved. Technology like projection mapping and augmented reality adds a wow factor to live experiences. Event planners can also utilize AI-driven tools for managing guest data, registrations, and post-event feedback./n
    By integrating innovative technology, events become more dynamic, interactive, and memorable./n`,
    date: "May 10, 2024",
    author: {
      name: "Mark Wanjala",
  ...
  },
  {
    ...
    body: `Guest safety is paramount at any event. Begin by identifying potential risks and creating an actionable safety plan. Partner with professional security teams for large-scale events and ensure clear emergency exits and protocols are in place./n 
    Health and comfort also matter—provide first aid stations, hand sanitizing areas, and accessibility options. Educate staff on safety procedures, and communicate rules clearly to attendees. Whether it's crowd control or weather contingencies, preparation is key to creating a worry-free experience for all guests./n`,
    date: "May 15, 2024",
    author: {
      name: "Anne Mutua",
  ...
  },
  {
    ...
    Use digital invitations instead of printed ones and prioritize local vendors to minimize transportation emissions. When it comes to catering, choose seasonal, organic ingredients and avoid single-use plastics. Provide clearly labeled recycling and compost bins at the event./n
    Sustainable decor options, like potted plants instead of cut flowers, can add charm without waste. Donating leftover food and materials can also make a positive impact. By integrating these practices, you can host events that are both memorable and environmentally responsible./n`,
    date: "May 25, 2024",
    author: {
      name: "John Mwangi",
  ...
  },
  {
    ...
    body: `Networking is a key goal for many event attendees. As a host, your role is to create an environment that encourages connections. Start with thoughtful seating arrangements that group people with shared interests. Incorporate networking breaks into the schedule, allowing attendees to mingle in a relaxed setting./n
    Interactive activities, like icebreakers or team-building exercises, can help ease nerves and foster collaboration. Provide tools like name tags with fun prompts (e.g., “Ask me about...”) to spark conversations. Hosting smaller breakout sessions or roundtable discussions is another effective way to facilitate deeper connections./n
    For virtual events, use breakout rooms, chat features, and networking platforms to replicate in-person interactions. Remember, your event’s success isn’t just measured by attendance—it’s also about the value attendees derive from meaningful connections./n`,
    date: "May 30, 2024",
    author: {
      name: "Angela Wanjiru",
