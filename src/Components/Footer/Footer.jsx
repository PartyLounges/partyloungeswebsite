...
const Footer = () => {
  ...
  return (
    <motion.footer
      className="bg-main-blue-theme text-white py-8"
      initial={{ opacity: 0 }}
    ...
    >
      <div className="container mx-auto px-4 lg:px-16">
        ...
        >
          ...
          >
            <h2 className="text-white-theme-blue text-28 tablet:text-36 desktop:text-40 font-bold font-red-hat-display">About Us</h2>
          ...
          >
            <h3 className="text-white-theme-blue text-28 tablet:text-36 desktop:text-40 font-bold font-proximanova-bold">Quick Links</h3>
                    ...
                    <Link
                      ...
                      className={`${
                        isActive
                          ...
                          : "text-white-theme-blue hover:bg-white hover:text-main-blue-theme"
          ...
          >
            <h3 className="text-white-theme-blue text-28 tablet:text-36 desktop:text-40 font-bold font-proximanova-bold">Contact Info</h3>
        ...
        >
          <a
            href="#"
            className="text-white-theme-blue font-red-hat-display hover:text-theme-brown hover:bg-white p-3 rounded-full transition text-lg sm:text-xl md:text-2xl"
          >
        ...
        {/* Copyright Section */}
        <motion.div
          className="mt-8 border-t font-red-hat-display border-gray-500 pt-4 text-center text-white-theme-blue text-sm sm:text-base md:text-lg"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}  // Fade-in animation when scrolled into view
          viewport={{ once: true }}
